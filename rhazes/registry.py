...
class BeanRegistry:
    ...
    def register_service(self, cls, obj):
        service_details: ServiceDetails = getattr(obj, "service_details")()
        self._register(cls, obj, service_details.primary)
        if service_details.service_for is not None and service_details.service_for != cls:
            self._register(service_details.service_for, obj, service_details.primary)
